...
I've been learning Pig-Latin, so I made a translator! Ancay ouyay ackhay itway?

Download the code [here](https://metaproblems.com/44b8ae0c352c9c4ba5341259899b0948/ashhay.py) and and when you have your solution, connect to the remote service with `nc kubenode.mctf.io 30020`
...
--- oginlay ---
Enter usernameyay: qyay
Enter asswordpay: qpay
oginlay failed: Invalid usernameyay or asswordpay.
...
Enter usernameyay: q
Enter asswordpay: q
oginlay successful! User session granted.
...
--- Pig Latin-ify ---
Enter a string to convert to Pig Latin: q
Pig Latin: qay
...
--- Pig Latin-ify ---
Enter a string to convert to Pig Latin: it
Pig Latin: itway
