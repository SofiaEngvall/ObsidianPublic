...
GET - One parameter
`curl http://10.10.10.10/?cmd=id`

GET - Two parameter
`curl 'http://127.0.0.1?a=93695c1012da5ff3d98319cc78a05b48&b=ef023fe2%20d0ab90a3%26bc9c1fc2%23ed26d010'`

POST - One parameter
`curl -s http://10.10.10.10/ -d 'cmd=id'`
`-s` silent mode
`-d` post data
`curl http://127.0.0.1/ -d 'a=90533d57c8b9e64c8393e758f4f255de'`

POST - Two parameters
`curl http://127.0.0.1/ -d 'a=97e5902049e939a7fedd29eb1ed9ac88' -d 'b=3016a649%20f84b4396%2697268362%2319d412bb'`

POST - json data
`curl --header "Content-Type: application/json" --request POST --data '{"a":"ebb5b5257ef3bfaa1fcdc64000091765"}' http://127.0.0.1/`

#### Help

```sh
hacker@talking-web~level25:~$ curl --help
