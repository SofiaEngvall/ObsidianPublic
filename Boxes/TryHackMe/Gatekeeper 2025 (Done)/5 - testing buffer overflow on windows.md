...
We're opening Gatekeeper.exe in x32dbg and running it. Then we start out fuzzing script:
```sh
#!/usr/bin/env python3
...
steps = 0 #0 at start
step_size = 100  #if you get bad chrashes with one step size, try bigger and smaller steps
...
We get a crash at EIP 39654138:
![[Images/Pasted image 20250106172201.png]]
...
The offset in the input string is 146.
