...
Example:
```sh
user@ip-10-10-224-90:~/Public-Crypto-Basics/Task-7$ ls -la
total 16
drwxrwxr-x 2 user user 4096 Sep  1 03:44 .
drwxrwxr-x 4 user user 4096 Sep  2 14:40 ..
-rw-r--r-- 1 user user  263 Sep  1 03:38 message.gpg
-rw-r--r-- 1 user user 1367 Sep  1 03:38 tryhackme.key

ser@ip-10-10-224-90:~/Public-Crypto-Basics/Task-7$ gpg --import tryhackme.key 
...
user@ip-10-10-224-90:~/Public-Crypto-Basics/Task-7$ gpg --decrypt message.gpg 
